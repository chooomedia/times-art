...
function WP_Times_art_customize_register( $wp_customize ) {
...
add_action( 'customize_register', 'WP_Times_art_customize_register' );

add_action( 'wp_head', 'WP_Times_art_customizer_css');
function WP_Times_art_customizer_css()
{
    ?>
    <style type="text/css">
 ...
 */
function WP_Times_art_customize_preview_js() {
    wp_enqueue_script( 'WP_Times_art_customizer', get_template_directory_uri() . '/inc/assets/js/customizer.js', array( 'customize-preview' ), '20151215', true );
}
add_action( 'customize_preview_init', 'WP_Times_art_customize_preview_js' );
